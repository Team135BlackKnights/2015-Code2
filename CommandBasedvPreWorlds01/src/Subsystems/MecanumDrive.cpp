	...
	Subsystem("MecanumDrive")
{
		...
		*/
		...
		rightBump = NULL;//new DigitalInput(DIGITAL_RIGHT_BUMP);
		rightBumpValue = false;
}
...
bool MecanumDrive::GetRightBumpValue()
{
	return rightBump->Get();
}

DigitalInput* MecanumDrive::RightBump()
{
	return this->rightBump;
}
