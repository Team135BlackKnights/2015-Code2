...
{
	float newPower = collectPower * COLLECT_MAX_POWER;
	collectLeftMotor->Set(newPower * COLLECT_LEFT_INVERTED);
	collectRightMotor->Set(newPower * COLLECT_RIGHT_INVERTED);
	SmartDashboard::PutNumber("Roller Value", newPower);
}
