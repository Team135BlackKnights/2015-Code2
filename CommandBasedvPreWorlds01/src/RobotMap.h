...
// number and the module. For example you with a rangefinder:
    ...
    const int DIGITAL_EXTERNAL_LOWER = 1;
    ...
    const int ANALOG_GYRO_B = 9;

    const int ANALOG_LIDAR = 1;

    const int DIGITAL_RIGHT_BUMP = 0;
    ...
    const std::string 	T_SERIAL_RUNNING = "Serial Command Status",
						...
						T_LIDAR_DISTANCE_VALUE = "LIDAR One Distance Value",
						T_LIDAR_DISTANCE_VOLTAGE = "LIDAR Two Distance Votage",
